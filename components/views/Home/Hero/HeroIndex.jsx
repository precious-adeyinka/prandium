...
const HeroIndex = () => {
    return (
        <div className="h-auto md:h-[33rem] w-11/12 flex flex-col md:flex-row justify-center items-center bg-transparent">
            {/* Caption */}
            <div className="h-full w-full md:w-1/2 px-1 bg-transparent flex flex-col justify-start md:justify-center items-center md:items-start space-y-7 md:space-y-10 md:pl-32">
                ...
                <p className="w-full md:w-7/12 text-sm text-gray-500 text-center md:text-left font-medium">Check out our amazing community of food lovers and get inspired for breakfast.</p>
                <button className="w-46 bg-[#e85627] text-white py-2 px-5 rounded-md">Find my breakfast</button>
            </div>
            {/* Mockups */}
            <div className="h-full w-full md:w-1/2 bg-transparent flex items-center justify-center position relative overflow-x-auto md:overflow-x-hidden">
                {/* First */}
                <div className="h-full min-w-[450px] md:w-1/2 bg-transparent flex flex-col justify-start space-y-5 pr-5 items-end">
                    {/* Image */}
                    <div className="h-72 w-56 rounded-md bg-gray-200 shadow flex jusitfy-center items-center overflow-hidden position relative">
                        {/* badge */}
                ...
                {/* Second */}
                <div className="h-full md:w-1/2 bg-transparent flex flex-col justify-center space-y-5 pt-16 items-start">
                    <div className="h-40 w-40 rounded-md bg-[#fdf2e2] flex flex-col items-center justify-center space-y-1">
