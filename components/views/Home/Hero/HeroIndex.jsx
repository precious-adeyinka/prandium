...
const HeroIndex = () => {
    return (
        <div className="h-auto md:h-[33rem] w-11/12 flex flex-col md:flex-row justify-center items-center bg-transparent">
            ...
            {/* Mockups */}
            <div className={`${styled.nobars} h-full m-0 w-full md:w-1/2 bg-transparent flex items-center justify-start md:justify-center position relative overflow-x-auto md:overflow-x-hidden md:-ml-32`}>
                {/* First */}
                <div className="h-full min-w-[320px] md:w-1/2 bg-transparent flex flex-col justify-start space-y-5 pr-5 items-end">
                    {/* Image */}
